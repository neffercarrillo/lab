...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        temp_posts = self.posts.find().sort([('date',-1)])
        for temp_post in temp_posts:
            cursor.append(temp_post)
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            comments = []
            posts = self.posts.find({'permalink':permalink})
            post = posts[0]
            print post
            print post['_id']
            ...
            print post['comments']
            comments = post['comments']
            #post['comments'].append(1)
            post['comments'].append(comment)
            print post['comments']
            id = post['_id']
            self.posts.update_one({'_id':id},{'$set':{'comments':comments}})
